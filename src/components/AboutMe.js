  ...
  return (
    <div id='aboutme' className=''>
        <div className='flex flex-col items-center justify-center py-14 lg:py-20 px-5 lg:px-28  text-center'>
            ...
            <div>
                <p>I’m a <span className='font-medium underline'>frontend engineer</span> with a sharp focus on creating high-impact, <span className='font-medium underline'>responsive websites that enhance brand credibility and user engagement. </span> 
